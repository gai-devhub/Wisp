...
<head>
    ...
    <style>
        ...
        * {
        ...
        .contact-box {
            text-align: left;
            background: rgba(232, 103, 74, 0.06);
            border: 1px solid rgba(232, 103, 74, 0.15);
            border-radius: 12px;
            padding: 1rem 1.25rem;
            margin-bottom: 1.25rem;
        }
        .contact-box h2 { font-size: 0.9rem; font-weight: 600; color: #2B1F3D; margin-bottom: 0.75rem; }
        ...
        .contact-links span { color: #6E6178; }
        .contact-links .fa, .contact-links .fab, .contact-links .fas { width: 18px; text-align: center; }
        ...
        .logout-form button:hover { color: #2B1F3D; }
...
<body>
    ...
    <div class="container">
        ...
        @else
        <p class="contact-box" style="text-align: center;">Contact your administrator for assistance.</p>
        @endif
