        ...
        <div class="container">
            <div class="footer-grid">
                ...
                <div>
                    <h4>Legal</h4>
                    <ul style="list-style: none; margin-top: 20px;">
                        <li style="margin-bottom: 12px;"><a href="#" style="color: var(--text-muted); text-decoration: none;">Privacy</a></li>
                        <li style="margin-bottom: 12px;"><a href="#" style="color: var(--text-muted); text-decoration: none;">Terms</a></li>
                    </ul>
                </div>
            </div>
