    ...
    <div class="wrapper">
        <div class="email-container">
            <div class="content">
                ...
                <h1 class="title">Welcome to the magic! &#10024;</h1>
                <p>Hi there,</p>
                <p>Thank you for subscribing to the WISP newsletter! We're thrilled to have you on board.</p>

                <ul class="feature-list">
                    <li>First look at new, stunning templates as we release them</li>
                    <li>Updates on AI writer improvements and tone options</li>
                    <li>Special features and early access to our product roadmap</li>
                </ul>

                <p>Stay tuned — exciting updates are coming your way soon.</p>
                <p style="margin-top: 20px; font-size: 13px; color: #64748B;">Cheers,<br><strong style="color: #0F172A;">The WISP Team</strong></p>
            </div>
            <div class="footer">
                <p>&copy; {{ date('Y') }} WISP. All rights reserved.</p>
                <p>You're receiving this email because you subscribed to WISP updates.</p>
                <p><a href="{{ route('unsubscribe', $subscriber->token) }}">Unsubscribe</a></p>
            </div>
        </div>
    </div>
</body>
