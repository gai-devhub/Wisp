...
<head>
    ...
    <title>Message Updated — WISP</title>
...
<body>
    <div class="wrapper">
        <div class="email-container">
            <div class="content">
                <span class="eyebrow">Message Updated</span>
                <h1 class="title">Your message was updated</h1>
                <p>Hello {{ $user->username ?? 'User' }},</p>
                <p>Your message <strong>&ldquo;{{ $messageModel->title }}&rdquo;</strong> has been updated successfully.</p>

                <div class="info-box">
                    <p style="margin: 0 0 8px; font-weight: 700; color: #0F172A; font-size: 13px;">Changes made:</p>
                ...
                <div class="btn-wrap">
                    <a href="{{ route('user.my-messages.page') }}" class="btn" target="_blank" rel="noopener">View Messages</a>
                </div>

                <p style="margin-top: 20px; font-size: 13px; color: #64748B;">If you did not authorize these changes, please log in and review your security settings.<br><br>Thanks,<br><strong style="color: #0F172A;">{{ config('app.name') }}</strong></p>
            </div>
            <div class="footer">
