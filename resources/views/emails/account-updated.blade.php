...
<head>
    ...
    <title>Account Settings Updated — WISP</title>
    ...
    <div class="wrapper">
        <div class="email-container">
            <div class="content">
                ...
                <h1 class="title">Your account settings were updated</h1>
                <p>Hello {{ $user->username ?? 'User' }},</p>
                <p>We wanted to confirm that changes were recently made to your WISP account settings.</p>
                ...
                <p>If you initiated these changes, no further action is needed.</p>

                <div class="warn-box">
                    <strong>Didn't make these changes?</strong> Log in to your WISP dashboard immediately to update your password and review security settings.
                </div>
