...
<head>
    ...
    <title>Verify Your Email — WISP</title>
    ...
    <div class="wrapper">
        <div class="email-container">
            <div class="content">
                ...
                <p>Welcome to WISP, {{ $user->username ?? 'there' }}!</p>
                <p>We noticed you haven't verified your email address yet. Please click the button below to confirm your account:</p>

                <ul class="feature-list">
                    <li>Recover your account if you ever lose access</li>
                    <li>Receive delivery confirmations for scheduled wishes</li>
                    <li>Unlock security features like account passcodes</li>
                </ul>

                <div class="btn-wrap">
                    <a href="{{ $url }}" class="btn" target="_blank" rel="noopener">Verify Email Address</a>
                </div>

                <p>If you did not create an account on WISP, no further action is required.</p>
                <p style="margin-top: 20px; font-size: 13px; color: #64748B;">Thanks,<br><strong style="color: #0F172A;">{{ config('app.name') }}</strong></p>
            </div>
            <div class="footer">
