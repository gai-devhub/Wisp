...
<head>
    ...
    <title>Page View Alert — WISP</title>
...
<body>
    <div class="wrapper">
        <div class="email-container">
            <div class="content">
                <span class="eyebrow">Activity Alert</span>
                <h1 class="title">Your message was just viewed</h1>
                <p>Hello {{ $user->name ?? 'there' }},</p>
                <p>Someone just opened your message <strong>&ldquo;{{ $messageTitle }}&rdquo;</strong>.</p>

                <div class="info-box">
                    <div class="info-item">
                        <div class="info-label">Viewed At</div>
                ...
                <p>This automated alert is sent based on your WISP notification preferences.</p>

                <div class="btn-wrap">
                    <a href="{{ route('user.my-messages.page') }}" class="btn" target="_blank" rel="noopener">View My Messages</a>
                </div>
