...
<head>
    ...
    <style>
        ...
        h2 { color: var(--secondary); font-weight: 400; font-size: 1.5rem; }
        ...
        .logo:hover { border-color: var(--primary); }
        .logo img { width: 100%; height: 100%; object-fit: cover; }
        .content { display: inline-block; }
        .title { font-family: 'Inter', sans-serif; font-size: 1.5rem; font-weight: 600; color: var(--text); margin: 0; }
        .countdown, .countdownMessage { font-size: 0.8rem; margin-top: 1px; color: var(--secondary); }
        strong { color: var(--text); font-weight: 600; }
        b { font-weight: 600; color: var(--text); }
        .description { font-size: 1rem; color: #6b7280; margin-top: 5px; line-height: 1.6; }
        .overlay { position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(255,255,255,0.8); z-index: 9999; display: none; }
        #audioPlayer {
            position: fixed;
            bottom: 25px;
            right: 25px;
        ...
        @media (max-width: 600px) { h1 { font-size: 1.75rem; } .card { max-height: 75vh; } #audioPlayer { bottom: 10px; right: 10px; } }
        @media (max-width: 400px) { h1 { font-size: 1.5rem; } .card { max-height: 70vh; } }
...
<body>
    ...
    <div class="floating-elements">
        <div class="floating-element" style="width: 200px; height: 200px; top: 10%; right: 10%;"></div>
        <div class="floating-element" style="width: 120px; height: 120px; bottom: 20%; left: 5%;"></div>
    </div>
    ...
    <script>
        particlesJS("particles-js", {
            particles: {
                ...
                line_linked: { enable: true, distance: 200, color: "#d1d5db", opacity: 0.2, width: 1 },
