...
<head>
    ...
    <style>
        ...
        body {
            ...
            height: 100vh;
            text-align: center;
            background: linear-gradient(135deg, var(--bg) 0%, #5b21b6 50%, #7c3aed 100%);
        ...
        h2 { color: rgba(255,255,255,0.95); font-weight: 400; font-size: 2rem; }
        ...
        .card {
            ...
            border-radius: 24px;
            padding: 20px;
            box-shadow: 0 10px 40px rgba(0,0,0,0.2), 0 0 20px rgba(244, 114, 182, 0.15);
            margin-top: 20px;
            max-height: 85vh;
            overflow-y: auto;
        ...
        .description { font-size: 1.1rem; color: #5a4a6a; margin-top: 5px; line-height: 1.5; }
...
<body>
    ...
    <div class="floating-elements">
        <div class="floating-element" style="width: 100px; height: 100px; top: 18%; left: 12%;"></div>
        <div class="floating-element" style="width: 140px; height: 140px; top: 58%; right: 18%;"></div>
        <div class="floating-element" style="width: 80px; height: 80px; bottom: 22%; left: 22%;"></div>
    </div>
    ...
    <script>
        particlesJS("particles-js", {
            particles: {
                ...
                line_linked: { enable: true, distance: 150, color: "#f9a8d4", opacity: 0.35, width: 1 },
