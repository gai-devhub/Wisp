...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Lora:wght@400;600;700&family=Source+Sans+3:wght@300;400;600&display=swap"
        rel="stylesheet">
    <style>
        :root {
            --primary: #059669;
...
<body>
    ...
    <div class="card">
        ...
        <p class="description">
            <strong>{{ $message->greeting }}</strong></br></br>{!! nl2br(e($message->message)) !!}</br></br></br><b>{{ $message->last_note }}</b>
        </p>
    </div>
