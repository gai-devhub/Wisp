...
<head>
    ...
    <style>
        ...
        body {
            ...
            height: 100vh;
            text-align: center;
            background: linear-gradient(180deg, var(--bg) 0%, #064e3b 100%);
        ...
        h2 { color: rgba(255,255,255,0.9); font-weight: 400; font-size: 2rem; }
        ...
        .title { font-family: 'Lora', serif; font-size: 1.8rem; color: var(--text); margin: 0; }
        .countdown, .countdownMessage { font-size: 0.8rem; margin-top: 1px; color: var(--secondary); text-shadow: 0 0 10px rgba(5,150,105,0.3); }
        ...
        .description { font-size: 1.1rem; color: #395e5a; margin-top: 5px; line-height: 1.5; }
...
<body>
    ...
    <div class="floating-elements">
        <div class="floating-element" style="width: 100px; height: 100px; top: 25%; left: 10%;"></div>
        <div class="floating-element" style="width: 140px; height: 140px; top: 55%; right: 20%;"></div>
        <div class="floating-element" style="width: 70px; height: 70px; bottom: 25%; left: 25%;"></div>
    </div>
    ...
    <script>
        particlesJS("particles-js", {
            particles: {
                ...
                line_linked: { enable: true, distance: 150, color: "#6ee7b7", opacity: 0.3, width: 1 },
