...
<head>
    ...
    <style>
        ...
        body {
            ...
            height: 100vh;
            text-align: center;
            background: linear-gradient(135deg, var(--bg) 0%, #292524 100%);
        ...
        h2 { color: var(--secondary); font-weight: 400; font-size: 2rem; }
        ...
        .card {
            ...
            border-radius: 16px;
            padding: 20px;
            box-shadow: 0 10px 40px rgba(0,0,0,0.2), 0 0 30px rgba(212, 175, 55, 0.1);
            margin-top: 20px;
            max-height: 85vh;
            overflow-y: auto;
        ...
        .logo:hover { transform: scale(1.08); box-shadow: 0 0 25px rgba(212, 175, 55, 0.6); }
        .logo img { width: 100%; height: 100%; object-fit: cover; }
        .content { display: inline-block; }
        .title { font-family: 'Playfair Display', serif; font-size: 1.8rem; color: var(--text); margin: 0; }
        .countdown, .countdownMessage { font-size: 0.8rem; margin-top: 1px; color: var(--secondary); text-shadow: 0 0 8px rgba(212,175,55,0.4); }
        ...
        .description { font-size: 1.1rem; color: #44403c; margin-top: 5px; line-height: 1.5; }
        ...
        #audioPlayer {
            ...
            padding: 10px;
            border-radius: 50px;
            box-shadow: 0 4px 20px rgba(0,0,0,0.2), 0 0 15px rgba(212, 175, 55, 0.2);
            z-index: 1000;
...
<body>
    ...
    <div class="floating-elements">
        <div class="floating-element" style="width: 90px; height: 90px; top: 20%; left: 15%;"></div>
        <div class="floating-element" style="width: 130px; height: 130px; top: 60%; right: 15%;"></div>
        <div class="floating-element" style="width: 70px; height: 70px; bottom: 20%; left: 30%;"></div>
    </div>
    ...
    <div class="card">
        ...
        <p class="description"><strong>{{ $message->greeting }}</strong></br></br>{!! nl2br(e($message->message)) !!}</br></br></br><b>{{ $message->last_note }}</b></p>
    </div>
    ...
    <script>
        particlesJS("particles-js", {
            particles: {
                ...
                line_linked: { enable: true, distance: 140, color: "#fcd34d", opacity: 0.35, width: 1 },
